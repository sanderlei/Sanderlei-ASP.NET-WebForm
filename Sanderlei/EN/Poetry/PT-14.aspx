<%@ Page Title="Mário de Sá-Carneiro - Quase" Language="C#" MasterPageFile="~/EN/SitePTPoesia.master" AutoEventWireup="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>  <h1> Mário de Sá-Carneiro - Quase </h1>  <br> <br> 
              <div class="embed-responsive embed-responsive-16by9">
                 <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zkLhwHqXVm4" frameborder="0" allowfullscreen></iframe>  </div>  <br> 
            <div class='text-center' style='line-height:1.7'> <Br />  <p> </p> 
               <h3> Mário de Sá-Carneiro - Quase</h3>
                <Br /> 
...
<Br /> 
 ...
 <p> Se ao menos eu permanecesse aquém... </p>           
<Br /> 
                <h4>Mário de Sá-Carneiro (1890-1916) </h4>
