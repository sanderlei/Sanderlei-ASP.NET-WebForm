<%@ Page Title="Jose Regio - Cantico Negro" Language="C#" MasterPageFile="~/EN/SitePTPoesia.master" AutoEventWireup="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>  <h1> Jose Regio - Cantico Negro </h1>  <br> <br> 
              <div class="embed-responsive embed-responsive-16by9">
                 <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/M1qEVRhEbmo" frameborder="0" allowfullscreen></iframe>  </div>  <br> 
            <div class='text-center' style='line-height:1.7'> <Br />  <p> </p>  
              <h3>  Jose Regio - Cantico Negro</h3>
                <Br /> 
 <p> "Vem por aqui" — dizem-me alguns com os olhos doces </p>             
...
<p> Tendes pátria, tendes tetos, </p>             
...
<Br /> 
<h4>José Régio, pseudônimo literário de </h4>
<h4>José Maria dos Reis Pereira(1901-1969)</h4>
<h4>foi um escritor português.</h4>
