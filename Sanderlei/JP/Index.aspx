<%@ Page Title="ホームページ" Language="C#" MasterPageFile="~/SiteJP.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.JP.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <meta name="description" content="Sanderleiシルベイラのプロフィール。文学、歴史、情報技術およびその他の..." />
</asp:Content>
