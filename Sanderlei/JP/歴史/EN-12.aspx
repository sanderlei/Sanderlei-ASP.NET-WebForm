<%@ Page Title="12. ローマ文明" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-12.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_12" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="ローマ文明は、上に成り立っ小さな農村から来ました..." /> 
</asp:Content>
