<%@ Page Title="19. 十字軍" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-19.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_19" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="十字軍キリスト教のインスピレーションの軍事行動のいずれかと呼ばれます..." /> 
</asp:Content>
