<%@ Page Title="17. 封建制度" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-17.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_17" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content=" 封建制度は、社会的、政治的、組織の形でした..." /> 
</asp:Content>
