<%@ Page Title="06. メソポタミア" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-06.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_06" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="文明の発祥地と考え、メソポタミアはどこにありました..." /> 
</asp:Content>
