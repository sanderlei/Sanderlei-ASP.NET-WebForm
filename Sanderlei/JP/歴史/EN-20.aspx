<%@ Page Title="20. 黒死病" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-20.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="黒死病は、の3分の1を殺した流行でした..." /> 
</asp:Content>
