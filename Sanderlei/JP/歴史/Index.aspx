<%@ Page Title="1分で歴史" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.JP.歴史.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="あなたがどこでも読むことが人間の歴史の中で60の主要なイベントは、簡単な方法で語りました。" />
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <br>
            <br>
            <p>あなたがどこでも読むことが人間の歴史の中で60の主要なイベントは、簡単な方法で語りました。</p>                    
            <br>
            <br>
            <div class="container-fluid">	           
                ...
                <a href='EN-03'>
               <h3 style="color:black">先史時代 </h3>               
      <p class="text-justify" style="color:black"> 先史時代は、最初の発生すると250万年前の期間であります...</p>
      ...
      <p class="text-justify" style="color:black">今日の主要な宗教は、古代史の間に開始しました。しかし、それは...</p>
      ...
      <br></div>
                      ...
                      <div class='col-xs-12 col-sm-4 text-center bg-info'> 
                <a href='EN-60'>
               <h3 style="color:black">アラブの春 </h3>               
      <p class="text-justify" style="color:black">アラブの春は、国際的にデモとの革命的な波として知られています...</p>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
          ...
          <a href="https://twitter.com/share" class="twitter-share-button" 
                            data-url="http://www.historia1minuto.com.br" data-size="large" data-via="ssanderlei" data-lang="ja">Tweet</a>
