<%@ Page Title="40. ブラジル共和国" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-40.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_40" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="1889年11月15日に、元帥デオドーロダフォンセカは、定められました..." /> 
</asp:Content>
