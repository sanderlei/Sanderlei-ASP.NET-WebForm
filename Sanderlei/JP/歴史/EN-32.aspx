<%@ Page Title="32. ナポレオン戦争" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-32.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_32" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="ナポレオンは、第1回領事皇帝として権力を握りました。.." /> 
</asp:Content>
