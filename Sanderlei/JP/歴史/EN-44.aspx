<%@ Page Title="44. モダニズム" Language="C#" MasterPageFile="~/JP/SiteJP歴史.master" AutoEventWireup="true" CodeBehind="EN-44.aspx.cs" Inherits="Sanderlei.JP.歴史.EN_44" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="モダニズムは文化的な動き、学校、の集まりです..." /> 
</asp:Content>
