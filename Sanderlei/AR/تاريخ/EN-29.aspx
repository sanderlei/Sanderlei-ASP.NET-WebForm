<%@ Page Title="29. الثورة الفرنسية" Language="C#" MasterPageFile="~/AR/SiteARHistory.master" AutoEventWireup="true" CodeBehind="EN-29.aspx.cs" Inherits="Sanderlei.AR.تاريخ.EN_29" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="حدثت الثورة الفرنسية بين" /> 
</asp:Content>
