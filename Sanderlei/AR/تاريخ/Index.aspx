      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>            
	                  <br>
            <br>
            <h2>التاريخ في 1 دقيقة</h2>
            <br>
            <br>
            <p>وقالت الأحداث الكبرى 60 في تاريخ البشرية بطريقة سهلة بالنسبة لك لقراءة أي مكان.</p>                    
            <br>
            <br>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
          ...
          <a href="https://twitter.com/share" class="twitter-share-button" 
                            data-url="http://www.historia1minuto.com.br" data-size="large" data-via="ssanderlei" data-lang="ar">Tweet</a>
