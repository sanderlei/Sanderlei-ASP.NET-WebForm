<%@ Page Title="La storia in 1 minuto" Language="C#" MasterPageFile="~/IT/SiteITStoria.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.IT.Storia.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Le 60 principali eventi della storia umana raccontate in un modo semplice per voi a leggere ovunque..." /> 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
     <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>            
	                  <br>
            <br>
            <h2>La storia in 1 minuto</h2>
            <br>
            <br>
            <p>Le 60 principali eventi della storia umana raccontate in un modo semplice per voi a leggere ovunque.</p>                    
            <br>
            <br>
            <div class="container-fluid">	           
                ...
                <a href='EN-03'>
               <h3 style="color:black">Preistoria </h3>               
      <p class="text-justify" style="color:black"> La preistoria è il periodo che va dal 2500 mila anni fa, con il sorgere del primo ...</p>
      ...
      <br></div>
                ...
                <a href='EN-05'>
               <h3 style="color:black">Religione</h3>               
      <p class="text-justify" style="color:black">Le principali religioni di oggi sono state avviate nel corso della storia antica. Ma è ...</p>
      ...
      <br></div>
                      ...
                      <div class='col-xs-12 col-sm-4 text-center bg-info'> 
                <a href='EN-60'>
               <h3 style="color:black">Primavera Araba </h3>               
      <p class="text-justify" style="color:black">Primavera araba è conosciuto a livello internazionale come una ondata rivoluzionaria di manifestazioni e ...</p>
