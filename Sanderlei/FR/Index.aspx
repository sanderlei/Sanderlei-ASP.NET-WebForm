<%@ Page Title="Page personnelle" Language="C#" MasterPageFile="~/SiteFR.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.FR.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <meta name="description" content="Page personnelle de Sanderlei Silveira. Littérature, Histoire, Informatique et autres ..." />
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>            
	                  <br>
            <br>
            <h2>Histoire en 1 minute</h2>
            <br>
            <br>
            <p>Les 60 événements majeurs dans l'histoire humaine ont dit d'une manière facile pour vous de lire n'importe où.</p>                    
            <br>
            <br>
            <div class="container-fluid">	           
            
                <div class='col-xs-12 col-sm-4 text-center bg-info'> 
                <a href='/FR/Histoire/EN-03'>
