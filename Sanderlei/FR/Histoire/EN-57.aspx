<%@ Page Title="57. Guerre contre le Terrorisme" Language="C#" MasterPageFile="~/FR/SiteFRHistoire.master" AutoEventWireup="true" CodeBehind="EN-57.aspx.cs" Inherits="Sanderlei.FR.Histoire.EN_57" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="La guerre contre le terrorisme est une initiative militaire déclenchée par la..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              The War on Terror is a military initiative unleashed by the
              </span>      
                      
             
   United States since the September 11 attacks. The President George W. Bush declared the War on Terror as part of an overall strategy to combat terrorism. </p><p>
Initially neoconservative with strong religious appeal, George Bush even declared a 'Crusade against terror" and against the "Axis of Evil", in what became known as the Bush Doctrine. This has generated strong reaction among European allies, which ended up requiring greater moderation in the use of historical-religious concepts in anti-terror rhetoric. The attack was treated as an act of war, with the government would assume much greater powers than had to chase and detain persons abroad, as well as to promote domestic spying, everything as if it were a war. </p><p>
The War on Terror meant a mobilization effort at different levels: political-diplomatic, economic, military, intelligence and counter intelligence. As part of the military operations of the War on Terror, the United States invaded and occupied Afghanistan shortly after the terrorist attacks and remained with his troops until the beginning of the withdrawal of the first soldiers of his troop in Afghanistan in 2011. </p><p>
