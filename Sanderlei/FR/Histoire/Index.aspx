<%@ Page Title="Histoire en 1 minute" Language="C#" MasterPageFile="~/FR/SiteFRHistoire.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.FR.Histoire.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Les 60 événements majeurs dans l'histoire humaine ont dit d'une manière facile pour vous de lire n'importe où..." />
</asp:Content>
