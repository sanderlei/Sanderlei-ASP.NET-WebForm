<%@ Page Title="43. Grande Dépression de 1929" Language="C#" MasterPageFile="~/FR/SiteFRHistoire.master" AutoEventWireup="true" CodeBehind="EN-43.aspx.cs" Inherits="Sanderlei.FR.Histoire.EN_43" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content=" Dans la fin de la Première Guerre mondiale, les pays européens ont trouvé..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
               In the end of World War I, European countries found
              </span>      
                      
             
      themselves devastated, with the weak economy and strong consumer downturn that shook the world economy. The United States in turn profited from the export of food and industrial products to the allied countries in the postwar period. As a result, between 1918 and 1928 the U.S. production increased economic prosperity and spawned the American way of life. However, the European economy has recovered and subsequently began to import fewer USA. With lower consumption in Europe, the U.S. industries no longer had anyone to sell. There were more goods than consumers and consequently prices fell, production fell and unemployment rose logo. Falling profits, the overall decline in industrial production and stoppage of trade resulted in decline in shares of the stock exchange and later in the stock market crash in 1929 and that persisted throughout the 1930s, ending only with the  World War II. </p><p>
