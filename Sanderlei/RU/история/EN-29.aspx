<%@ Page Title="29. Французская Революция" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-29.aspx.cs" Inherits="Sanderlei.RU.история.EN_29" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Французская революция произошла между ..." /> 
</asp:Content>
