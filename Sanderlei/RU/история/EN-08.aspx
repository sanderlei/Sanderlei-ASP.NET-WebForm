<%@ Page Title="08. Евреям - иудаизм" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-08.aspx.cs" Inherits="Sanderlei.RU.история.EN_08" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content=" Евреям также известный как израильтян, а позже евреи ..." /> 
</asp:Content>
