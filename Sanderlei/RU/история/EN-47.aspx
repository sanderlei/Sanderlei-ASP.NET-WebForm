<%@ Page Title="47. нацизм" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-47.aspx.cs" Inherits="Sanderlei.RU.история.EN_47" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Нацизм это идеология практикуется нацистской партии..." /> 
</asp:Content>
