<%@ Page Title="57. Война с террором" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-57.aspx.cs" Inherits="Sanderlei.RU.история.EN_57" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="Война с террором является военная инициатива развязанная ..." /> 
</asp:Content>
