<%@ Page Title="01. Вселенная Хронология" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-01.aspx.cs" Inherits="Sanderlei.RU.история.EN_01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Вселенная начала около 13 миллиардов лет назад, по ..." /> 
</asp:Content>
