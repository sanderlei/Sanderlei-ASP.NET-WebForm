<%@ Page Title="48. Вторая мировая война" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-48.aspx.cs" Inherits="Sanderlei.RU.история.EN_48" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="Вторая мировая война была глобальной военной конфликт, который ..." /> 
</asp:Content>
