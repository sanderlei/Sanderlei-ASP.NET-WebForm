<%@ Page Title="25. протестантская Реформация" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-25.aspx.cs" Inherits="Sanderlei.RU.история.EN_25" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Протестантская Реформация была движением, ..." /> 
</asp:Content>
