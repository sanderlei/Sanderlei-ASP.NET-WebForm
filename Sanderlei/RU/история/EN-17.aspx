<%@ Page Title="17. феодализм" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-17.aspx.cs" Inherits="Sanderlei.RU.история.EN_17" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="Феодализм был формой социальной и политической организации, что..." /> 
</asp:Content>
