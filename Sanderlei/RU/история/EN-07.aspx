<%@ Page Title="07. Древний Египет" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-07.aspx.cs" Inherits="Sanderlei.RU.история.EN_07" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Один из первых великих цивилизаций человечества египетской ..." /> 
</asp:Content>
