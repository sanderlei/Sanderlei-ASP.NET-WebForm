<%@ Page Title="31. Индустриальная Революция" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-31.aspx.cs" Inherits="Sanderlei.RU.история.EN_31" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Промышленная революция наряду с независимости ..." /> 
</asp:Content>
