<%@ Page Title="32. Наполеоновские войны" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-32.aspx.cs" Inherits="Sanderlei.RU.история.EN_32" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Наполеон пришел к власти в 1-й консул императора ..." /> 
</asp:Content>
