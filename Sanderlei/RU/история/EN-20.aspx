<%@ Page Title="20. Черная Смерть" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-20.aspx.cs" Inherits="Sanderlei.RU.история.EN_20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Черная смерть была эпидемия, которая убила треть ..." /> 
</asp:Content>
