<%@ Page Title="38. Прекрасной эпохи" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-38.aspx.cs" Inherits="Sanderlei.RU.история.EN_38" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="он Прекрасной эпохи был период в истории Европы, что ..." /> 
</asp:Content>
