<%@ Page Title="22. Возраст Discovery" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-22.aspx.cs" Inherits="Sanderlei.RU.история.EN_22" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content=" Возраст открытия ознаменовала принятие феодализма ..." /> 
</asp:Content>
