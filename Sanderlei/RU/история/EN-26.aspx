<%@ Page Title="26. Европейский абсолютизм" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-26.aspx.cs" Inherits="Sanderlei.RU.история.EN_26" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Это было политическая партия, которая была величайшие преобразования ..." /> 
</asp:Content>
