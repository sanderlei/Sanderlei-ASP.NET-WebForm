<%@ Page Title="37. Объединение Германии" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-37.aspx.cs" Inherits="Sanderlei.RU.история.EN_37" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Объединение Германии, политически и административно, в ..." /> 
</asp:Content>
