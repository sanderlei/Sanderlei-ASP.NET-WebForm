<%@ Page Title="06. Месопотамия" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-06.aspx.cs" Inherits="Sanderlei.RU.история.EN_06" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Считается колыбелью цивилизации, Месопотамия была, где ..." /> 
</asp:Content>
