<%@ Page Title="16. Королевство франков" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-16.aspx.cs" Inherits="Sanderlei.RU.история.EN_16" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Большинство варварских королевств формируется из ..." /> 
</asp:Content>
