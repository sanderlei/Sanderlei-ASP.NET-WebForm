<%@ Page Title="59. Великая рецессия" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-59.aspx.cs" Inherits="Sanderlei.RU.история.EN_59" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Великая рецессия является глобальный экономический кризис еще будучи..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              The Great Recession is a global economic crisis still being
              </span>      
                      
              
     felt after the international financial crisis precipitated by the collapse of traditional American investment bank Lehman Brothers. In a domino effect, other large financial institutions broke in the process also known as the subprime crisis.</p><p>
Some economists, however, believe that the subprime crisis has its first issue in the burst of the Internet bubble in 2001, when the Nasdaq plummeted.</p><p>
Anyway, Lehman Brothers was followed within a few days, the technical failure of the largest insurance company in the United States of America, American International Group (AIG). The U.S. government, which refused to provide assurances that the British bank Barclays to acquire control of the tottering Lehman Brothers, alarmed by the systemic effect that the failure of this traditional and powerful financial institution - abandoned the "market solutions" - provoked in global financial markets, it decided, in twenty-four hours, inject eighty five billion dollars of public money to save AIG in its operations. But within weeks, the U.S. crisis has already crossed the Atlantic: Iceland nationalized the second largest bank in the country, passing by serious difficulties.</p><p>
The most important financial institutions in the world said they had huge losses on their balance sheets, which aggravated the climate of distrust, which became widespread. In Brazil, Sadia, Aracruz Celulose and Votorantim companies announced billions in losses.</p><p>
To prevent collapse, the U.S. government nationalized mortgage agencies Fannie Mae and Freddie Mac, privatized in 1968, which will now be under the control of government indefinitely.</p><p>
In October 2008, Germany, France, Austria, the Netherlands and Italy have announced packages totaling 1.17 trillion euros in aid to their financial systems. The Eurozone GDP fell by 1.5% in the fourth quarter of 2008 compared to the previous quarter, the biggest contraction of the history of the area economy.</p><p>
