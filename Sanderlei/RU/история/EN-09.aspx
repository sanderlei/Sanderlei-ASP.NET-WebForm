<%@ Page Title="09. Древняя Греция" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-09.aspx.cs" Inherits="Sanderlei.RU.история.EN_09" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Исторический период, называемый Древней Греции ..." /> 
</asp:Content>
