<%@ Page Title="23. современная эпоха" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-23.aspx.cs" Inherits="Sanderlei.RU.история.EN_23" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="В конце пятнадцатого века и начале шестнадцатого века, европейцы пересекают ..." />
</asp:Content>
