<%@ Page Title="История в 1 минуту" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.RU.история.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="60 крупных мероприятий в человеческой истории рассказал в простой способ для вас, чтобы читать в любом месте...." />
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>            
	                  <br>
            <br>
            <h1>История в 1 минуту</h1>
            <br>
            <br>
            <p>60 крупных мероприятий в человеческой истории рассказал в простой способ для вас, чтобы читать в любом месте.</p>                    
            <br>
            <br>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
          ...
          <a href="https://twitter.com/share" class="twitter-share-button" 
                            data-url="http://www.historia1minuto.com.br" data-size="large" data-via="ssanderlei" data-lang="ru">Tweet</a>
