<%@ Page Title="50. Деколонизация Африки" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-50.aspx.cs" Inherits="Sanderlei.RU.история.EN_50" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
       <meta name="description" content="В конце Средневековья государства Европы начали..." /> 
</asp:Content>
