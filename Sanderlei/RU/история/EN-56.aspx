<%@ Page Title="56. Нападения 11 сентября" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-56.aspx.cs" Inherits="Sanderlei.RU.история.EN_56" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Террористические атаки 11 сентября 2001 гг ..." /> 
</asp:Content>
