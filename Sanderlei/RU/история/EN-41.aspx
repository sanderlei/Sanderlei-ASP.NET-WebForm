<%@ Page Title="41. Первая Мировая Война" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-41.aspx.cs" Inherits="Sanderlei.RU.история.EN_41" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Первая мировая война началась 28 июля 1914 и продолжалась до ..." /> 
</asp:Content>
