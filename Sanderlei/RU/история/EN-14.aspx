<%@ Page Title="14. Византийская Империя" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-14.aspx.cs" Inherits="Sanderlei.RU.история.EN_14" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Византийская империя является первым большим Империя во ..." /> 
</asp:Content>
