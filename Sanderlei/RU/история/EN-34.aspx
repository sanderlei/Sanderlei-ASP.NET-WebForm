<%@ Page Title="34. Независимость Испанской Америки" Language="C#" MasterPageFile="~/RU/SiteRUHistory.master" AutoEventWireup="true" CodeBehind="EN-34.aspx.cs" Inherits="Sanderlei.RU.история.EN_34" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Войны за независимость в Испанской Америке начинается ..." /> 
</asp:Content>
