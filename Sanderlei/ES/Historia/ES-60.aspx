<%@ Page Title="60. Primavera Árabe (español)" Language="C#" MasterPageFile="~/ES/SiteESHistoria.master" AutoEventWireup="true" CodeBehind="ES-60.aspx.cs" Inherits="Sanderlei.ES.Historia.ES_60" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="La primavera árabe es conocida internacionalmente como una ola..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              La primavera árabe es conocida internacionalmente como una ola
              </span>      
                      
              
       revolucionaria de manifestaciones y protestas que ocurren en el Medio Oriente y África del Norte desde el 18 de diciembre de 2010. Hasta la fecha, ha habido revoluciones en Túnez y Egipto, una guerra civil en Libia y Siria, también ha habido grandes protestas en Argelia, Bahrein, Djibouti, Iraq, Jordania, Omán y Yemen y protestas menores en Kuwait, Líbano, Mauritania, Marruecos, Arabia Saudita, Sudán y el Sáhara Occidental. Las protestas han compartido las técnicas de resistencia civil en campañas sostenidas involucran huelgas, manifestaciones, marchas y manifestaciones, así como el uso de medios sociales como Facebook, Twitter y Youtube, para organizar, comunicar y crear conciencia de la comunidad internacional frente a los intentos la represión y la censura de Internet en algunas partes de los Estados.</p><p>
Las redes sociales han desempeñado un papel considerable en los movimientos recientes contra la dictadura en los países árabes y no habrían sido lo mismo sin los recursos que ofrece Internet .</p><p>
En diciembre de 2010, un joven tunecino, Mohamed Bouazizi, prendió fuego a su cuerpo como una forma de protesta contra las condiciones de vida en el país en el que vivían. Él no lo sabía, pero el acto desesperado, que terminó con su vida, daría lugar a lo que más tarde se dio en llamar la Primavera Árabe. Las protestas se extienden a través de Túnez, teniendo el presidente Zine el-Abdine Ben Ali a huir a Arabia Saudita sólo diez días después. Ben Ali estuvo en el poder desde noviembre de 1987.</p><p>
