<%@ Page Title="52. Zweiten brasilianischen Republik (1945-1964)" Language="C#" MasterPageFile="~/DE/SiteDEGeschichte.master" AutoEventWireup="true" CodeBehind="EN-52.aspx.cs" Inherits="Sanderlei.DE.Geschichte.EN_52" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="Der Zeitraum wie die New Republic bekannt beginnt mit der ..." /> 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br><h1>                                            
              52. Second Brazilian Republic (1945-1964)         
			</h1><br><br> 
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              The period known as the New Republic starts with the
              </span>      
                      
             
         forced resignation of Vargas in 1945 and in 1964 with the military coup. </p><p>
After the departure of Vargas, General Eurico Gaspar Dutra was elected president and took office the following year. In 1946 was promulgated new constitution restoring individual rights. </p><p>
In 1950, Brazil gets World Cup Soccer. Despite losing the final to Uruguay by 2-1, definitely puts the country among the international scene, breaks all records in leaves and as the country's largest legacy Maracanã Stadium. Back in 1950 inaugurated the TV Tupi São Paulo. </p><p>
This year, Vargas was once elected president, this time by direct vote instead. In his second administration Petrobras, the result of nationalist tendencies that received support layers of workers, intellectuals and student movement was created. However, times were not the same, and Vargas could not drive so well his government. Pressed by a series of events in 1954 Getulio Vargas commits suicide within the Presidential Palace. Assumes the vice-president, João Fernandes Campos Café Filho. </p><p>
In 1955, Juscelino Kubitschek was elected president and took office in January 1956, although it has faced coup attempts. His rule was characterized by so-called developmentalism, doctrine held that the technical and industrial advances as supposed evidence of a general progress of the country. The motto of developmentalism under Juscelino was 50 years 5. In 1960, Kubitschek inaugurated Brasilia, the new capital of Brazil. </p><p>
Already in 1961 Quadros took office, but resigned in August of the same year. Quadros, preached the moralization of the government, began his political career in the PDC and was elected with the support of UDN, did an adversarial government and attempted a rapprochement with the Soviet bloc for strictly economic purposes, but just was not the right interpretation in Brazil, which now boast panic with the imminence of communism. </p><p>
