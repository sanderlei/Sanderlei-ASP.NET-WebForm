<%@ Page Title="47. Nazismus" Language="C#" MasterPageFile="~/DE/SiteDEGeschichte.master" AutoEventWireup="true" CodeBehind="EN-47.aspx.cs" Inherits="Sanderlei.DE.Geschichte.EN_47" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Nationalsozialismus ist die Ideologie der NSDAP von praktiziert ..." /> 
</asp:Content>
...
Is Nazism led by Adolf Hitler responsible for the Holocaust was the genocide of six million Jews during World War II, through a systematic program of ethnic cleansing sponsored by the Nazi state. </p><p>
Of the nine million Jews who had resided in Europe before the Holocaust, approximately two-thirds were killed. A network of more than 40,000 installations in Germany and Nazi-occupied territories was used to concentrate, operate, maintain and kill Jews and other victims. </p><p>
