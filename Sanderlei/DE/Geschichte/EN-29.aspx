<%@ Page Title="29. Französisch Revolution" Language="C#" MasterPageFile="~/DE/SiteDEGeschichte.master" AutoEventWireup="true" CodeBehind="EN-29.aspx.cs" Inherits="Sanderlei.DE.Geschichte.EN_29" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content=" Die Französisch Revolution zwischen die aufgetreten ..." /> 
</asp:Content>
...
The modern era has unfolded in the shadow of the ideals conquered by the French Revolution. The growth of republics and liberal democracies around the world, the spread of secularism and the development of modern ideologies had its birth during the Revolution. And it's the end of the Modern Age and the entry of humanity in the Contemporary Age, which is the current specific period in the history of the Western world.
           ...
           <ul><li>
          1787: Revolt of Notables</li><li>
1789: Storming of the Bastille and the Declaration of the Rights of Man and of the Citizen.</li><li>
1790: Confiscation of the property of the clergy.</li><li>
1791: Constitution which established the constitutional monarchy .</li><li>
1791: Attempt to escape and imprisonment of King Louis XVI.</li><li>
1792: Invasion of France by Austria and Prussia.</li><li>
1793: Formalization of the Republic and death of King Louis XVI, 2nd Constitution.</li><li>
1793: Terror against enemies of the revolution.</li><li>
1794: Deposition of Robespierre.</li><li>
1795: Regime Directory - 3rd Constitution.</li><li>
1799: Coup of Napoleon in 18 Brumaire (November 9).</li>
