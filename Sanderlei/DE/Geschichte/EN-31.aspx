<%@ Page Title="31. Industrielle Revolution" Language="C#" MasterPageFile="~/DE/SiteDEGeschichte.master" AutoEventWireup="true" CodeBehind="EN-31.aspx.cs" Inherits="Sanderlei.DE.Geschichte.EN_31" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
     <meta name="description" content="Die industrielle Revolution zusammen mit der Unabhängigkeit des..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              The Industrial Revolution along with the Independence of the
              </span>      
                      
              
 United States and the French Revolution marks the transition the Modern Age to Contemporary Age. Industrial Revolution starts in 1760 and goes until 1830, just as a time reference, because the process of economic and social change took place gradually. The revolution began in the UK and in a few decades spread to Western Europe and the United States.</p><p>
The Industrial Revolution is a watershed in the history and almost all aspects of everyday life of the time were influenced in any way by this process. This transformation included the transition from craft production methods to produce machines for the manufacture of new chemicals, new processes for producing iron, greater energy efficiency of the water, the increasing use of steam power, and the replacement of wood by coal.</p><p>
The New Industrial Revolution that make the Scottish thinker Adam Smith seek to respond rationally to questions of time and write his book The Wealth of Nations in 1776, which is considered one of the founders of economic science works.</p><p>
During the second half of the nineteenth century, from 1850 to 1870, plus a number of developments within the chemical, electrical industry, oil and steel occurs. Other key developments during this period include the introduction of steam-powered steel ships, the development of the airplane, the mass production of consumer goods, food canning, mechanical refrigeration and other preservation techniques and the invention of the electromagnetic telephone. This period is considered as the Second Industrial Revolution.</p><p>
