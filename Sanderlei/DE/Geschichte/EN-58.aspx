<%@ Page Title="58. Digital Revolution" Language="C#" MasterPageFile="~/DE/SiteDEGeschichte.master" AutoEventWireup="true" CodeBehind="EN-58.aspx.cs" Inherits="Sanderlei.DE.Geschichte.EN_58" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      <meta name="description" content="In den späten 1960er Jahren entstand das Internet mit der ..." /> 
</asp:Content>
...
This began popularizing the digital revolution, which completely changed the society. The number of people surfing the Internet grows with each passing day. A new world full of advantages and facilities was discovered. Information, interactivity, personal relationships, negotiations, news, shopping and other necessities of day-to-day won a large web space. </p><p>
In 1998 it created the Google main search site today and one of the largest Internet companies. Google helped sort the web pages and facilitated the research service for information. </p><p>
And in 2004, Mark Zuckerberg, Facebook creates a strong social network that spreads throughout the world as a new mode of social interaction between people over the Internet. </p><p>
