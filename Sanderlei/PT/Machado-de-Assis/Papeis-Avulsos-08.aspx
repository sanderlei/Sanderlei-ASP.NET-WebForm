<%@ Page Title="Machado de Assis - Papéis Avulsos -  O ANEL DE POLÍCRATES  " Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content="  Há que anos! Era um nababo, rico, podre de rico, mas pródigo..   " /> 
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        ...
        <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
             <br /> <h2 class='text-center'>   O ANEL DE POLÍCRATES   </h2>        <br /> 
...
<p>O Xavier corre a vê-lo; e o infeliz ainda o pôde conhecer, estender-lhe a mão fria e trêmula, cravar-lhe um longo olhar baço da última hora, e, com a voz sumida, eco do sepulcro, soluçar-lhe: “Cá vou, meu Caro Xavier, o cavalo xucro ou manhoso da vida deitou-me ao chão: se fui mau cavaleiro, não sei; mas forcejei por parecê-lo bom”. Não se ria; ele contou-me isto com lágrimas. Contou-me também que a idéia ainda esvoaçou alguns minutos sobre o cadáver, faiscando as belas asas de cristal, que ele cria ser diamante depois estalou um risinho de escárnio, ingrato e parricida, e fugiu como das outras vezes, metendo-se no cérebro de alguns sujeitos, amigos da casa, que ali estavam, transidos de dor, e recolheram com saudade esse pio legado do defunto. Adeus. </p>
        ...
        <br />    <p class='text-center'> * * * </p>  <br /> <hr />  <br />            
          ...
          <!--  class="active"  -->
            ...
            <li  class="active"  ><a href="Papeis-Avulsos-08">08</a></li>
