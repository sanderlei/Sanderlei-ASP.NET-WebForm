<%@ Page Title="Machado de Assis -  José de Alencar: O Guarani   " Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content=" Crítica - José de Alencar: O Guarani  " /> 
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        ...
        <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
             <br /> <h2 class='text-center'>   José de Alencar: O Guarani   </h2>        <br /> 
...
<P>o escritor deixou neste mundo. Manon Lescaut, por exemplo, é a imortal novela daquele padre que escreveu tantas outras, agora esquecidas. O autor de Iracema e d' O Guarani pode esperar confiado. Há aqui mesmo uma inconsciente alegoria. Quando o Paraíba alaga tudo, Peri, para salvar Cecília, arranca uma palmeira, a poder de grandes esforços. Ninguém ainda esqueceu essa página magnífica. A palmeira tomba. Cecília é depositada nela. Peri murmura ao ouvido da moça: Tu viverás, e vão ambos por ali abaixo, entre água e céu, até que se somem no horizonte. Cecília é a alma do grande escritor, a árvore é a Pátria que a leva na grande torrente dos tempos. Tu viverás! </P>
        ...
        <br />    <p class='text-center'> * * * </p>  <br /> <hr />  <br />            
          ...
          <!--  class="active"  -->
            ...
            <li class="active"  ><a href="Critica-27">27</a></li>                                          
