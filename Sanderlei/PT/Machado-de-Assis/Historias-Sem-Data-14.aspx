<%@ Page Title="Machado de Assis - Histórias Sem Data - A SEGUNDA VIDA   " Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content="  Levantou-se, foi ao interior da casa, chamou o preto velho que o servia, e disse-lhe em voz baixa:  " /> 
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        ...
        <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
             <br /> <h2 class='text-center'>   A SEGUNDA VIDA   </h2>        <br /> 
                        
        
<H5> </H5>

<p>Monsenhor Caldas interrompeu a narração do desconhecido: </p>
...
<p>Levantou-se, foi ao interior da casa, chamou o preto velho que o servia, e disse-lhe em voz baixa: </p>
        ...
        <br />    <p class='text-center'> * * * </p>  <br /> <hr />  <br />            
          ...
          <!--  class="active"  -->
            ...
            <li    ><a href="Historias-Sem-Data-07">07</a></li>                             
              ...
              <li class="active"   ><a href="Historias-Sem-Data-14">14</a></li>                             
