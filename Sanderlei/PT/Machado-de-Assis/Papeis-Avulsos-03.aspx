<%@ Page Title="Machado de Assis - Papéis Avulsos -  TEORIA DO MEDALHÃO  " Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content="  Nem eu; conversemos um pouco. Abre a janela. Que horas são?    " /> 
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        ...
        <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
             <br /> <h2 class='text-center'>   TEORIA DO MEDALHÃO   </h2>        <br /> 
...
Entretanto, assim como é de boa economia guardar um pão para a velhice, assim também é de boa prática social acautelar um ofício para a hipótese de que os outros falhem, ou não indenizem suficientemente o esforço da nossa ambição. 
</p>

<p>É isto o que te aconselho hoje, dia da tua maioridade. </p>
...
<p>Quanto mais pano tem, mais poupa o corte, Menos monte alardeia de retalhos; </p>

<p>e este fenômeno, tratando-se de um medalhão, é que não seria científico. </p>
...
Meia-noite? Entras nos teus vinte e dois anos, meu peralta; estás definitivamente maior. Vamos dormir, que é tarde. Rumina bem o que te disse, meu filho. Guardadas as proporções, a conversa desta noite vale o Príncipe de Machiavelli. Vamos dormir. 
        ...
        <br />    <p class='text-center'> * * * </p>  <br /> <hr />  <br />            
          ...
          <!--  class="active"  -->
            ...
            <li class="active"    ><a href="Papeis-Avulsos-03">03</a></li>
