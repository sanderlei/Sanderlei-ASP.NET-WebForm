<%@ Page Title="Machado de Assis - A Mão e a Luva - 17 / 19" Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>            
            <h1> Machado de Assis - A Mão e a Luva - 17 / 19	</h1>
            <br />
            <div class="container-fluid">	            
                <div class='col-xs-12 col-sm-6 col-sm-offset-3 text-center'> 
              <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/XENncGSgLIA" frameborder="0" allowfullscreen></iframe>
              </div>   </div>    </div>                 
     </div> 
...
<p>Pela volta do meio-dia, recebeu a baronesa uma carta de Luís Alves. Abriu-a e leu-a. O advogado pedia-lhe a mão de Guiomar. Poucas linhas, corteses, simples, naturais, feitas por quem parecia senhor da situação. </p>
...
<p>A inglesa saiu dali e foi ter com Guiomar. Quando a viu de longe compôs um sorriso, e Guiomar, vendo-a sorrir, sentiu como que um movimento interno de repulsa. </p>
...
<p>Guiomar interrogou-a com os olhos. </p>
...
<p>Guiomar compreendeu de que se tratava. Olhou desdenhosamente para a inglesa, e disse em tom seco e breve: </p>
...
<p>Guiomar dispôs-se a ir ter com a madrinha; Mrs. Oswald fê-la parar um instante, e com a mais melíflua voz que possuía na escala da garganta, disse: </p>
...
Toda a felicidade desta casa está em suas mãos. 
      ...
      <div class="text-center"><ul class="pagination pagination-lg">
          <!--  class="active"  -->            
            ...
            <li class="active"  ><a href="A-Mao-e-a-Luva-17">17</a></li>
