<%@ Page Title="Machado de Assis -   A Estátua de José de Alencar  " Language="C#" MasterPageFile="~/PT/SitePTMachado.master" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content=" Miscelânea -  A Estátua de José de Alencar " /> 
</asp:Content>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        ...
        <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
             <br /> <h2 class='text-center'>   A Estátua de José de Alencar   </h2>        <br /> 
...
<P>Agora que os anos vão passando sobre o óbito do escritor, é justo perpetuá-lo, pela mão do nosso ilustre estatuário nacional. Concluindo o livro de Iracema, escreveu Alencar esta palavra melancólica: &quot;A jandaia cantava ainda no olho do coqueiro, mas não repetia já o mavioso nome de Iracema. Tudo passa sobre a terra&quot;. Senhores, a filosofia do livro não podia ser outra, mas a posteridade é aquela jandaia que não deixa o coqueiro, e que ao contrário da que emudeceu na novela, repete e repetirá o nome da linda tabajara e do seu imortal autor. Nem tudo passa sobre a terra. </P>
        ...
        <br />    <p class='text-center'> * * * </p>  <br /> <hr />  <br />            
          ...
          <!--  class="active"  -->
            <li class="active"   ><a href="Miscelanea-01">01</a></li>            
            ...
            <li   ><a href="Miscelanea-09">09</a></li>
