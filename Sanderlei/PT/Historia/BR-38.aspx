<%@ Page Title="38. Belle Époque" Language="C#" MasterPageFile="~/PT/SitePTHistoria.master" AutoEventWireup="true" CodeBehind="BR-38.aspx.cs" Inherits="Sanderlei.PT.Historia.BR_38" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    <meta name="description" content="A Belle Époque foi um período na história da Europa que..." /> 
</asp:Content>
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            ...
            <div class='text-justify' style='line-height:1.7'>
              <p><span class="lead">  
              A Belle Époque foi um período na história da Europa que
              </span>      
                começou no fim do século XIX e durou até a eclosão da Primeira Guerra Mundial em 1914. A expressão também designa o clima intelectual e artístico do período em questão. Foi uma época marcada por profundas transformações culturais que se traduziram em novos modos de pensar e viver o quotidiano.      
              </p><p>
             
Foi considerada uma era de ouro da beleza, inovação e paz entre os países europeus. Novas invenções tornavam a vida mais fácil em todos os níveis sociais, e a cena cultural estava em efervescência: cabaré e o cinema haviam nascido, e a arte tomava novas formas com o Impressionismo e a Arte Nouveau.  </p><p>
Inovações tecnológicas como o telefone, o telégrafo sem fio, o cinema, a bicicleta, o automóvel, o avião, inspiravam novas percepções da realidade. Com seus cafés-concertos, balés, óperas, livrarias, teatros e alta costura. Paris, a Cidade Luz, era considerada o centro produtor e exportador da cultura mundial.  </p><p>
...
Toda essa era de ouro durou até a eclosão da Primeira Guerra Mundial em 1914 na Europa. </p><p>
