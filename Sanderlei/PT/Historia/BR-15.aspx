...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
			...
			<p><span class="lead">
			 A civilização Islâmica surgiu na Arábia tendo como
			</span>
             seu fundador Maomé (Muhammad), que nasceu por volta de 570, data usada também como início da fundação do Islamismo, também chamado de Islão ou islã, é uma religião abraâmica monoteísta articulada pelo Corão.
			</p><p>
