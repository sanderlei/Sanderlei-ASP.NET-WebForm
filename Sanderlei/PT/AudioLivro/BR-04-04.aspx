<%@ Page Title="Lima Barreto - Triste Fim de Policarpo Quaresma - 04 / 15" Language="C#" MasterPageFile="~/PT/SitePTLivro.master" AutoEventWireup="true"  %>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>            
            <h1> Lima Barreto - Triste Fim de Policarpo Quaresma - 04 / 15	</h1>
            <br />
              <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MVSIi4bUEdQ" frameborder="0" allowfullscreen></iframe>
              </div>  <br /><br /><br />   <br /><br /><br />                  
     </div> 
           <div class='col-xs-12 col-md-12 text-justify' style='line-height:1.7'>
         <br /> 
                <h2 class='text-center'>Lima Barreto - O Triste Fim de Policarpo Quaresma </h2>
                 <br /> 
                <h3 class='text-center'> Desastrosas Conseqüências de um Requerimento </h3>
                <br /> 
