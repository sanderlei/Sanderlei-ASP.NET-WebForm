    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>            
            <h1> Machado de Assis - O Alienista - 07 / 09	</h1>
            <br />
              <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/eJCmoL5oS38" frameborder="0" allowfullscreen></iframe>
         ...
         <br /> 
                <h2 class='text-center'>Machado de Assis - O Alienista </h2>
                 <br /> 
                <h3 class='text-center'> CAPÍTULO XI - O ASSOMBRO DE ITAGUAÍ </h3>
                <br /> 
