<%@ Page Title="" Language="C#" MasterPageFile="~/PT/SitePTLivro.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sanderlei.PT.AudioLivro.Index" %>
        ...
        <div class='col-xs-12 col-md-12 text-center'>
           ...
           <br />
            ...
            <div class="container-fluid" style="background-color:black">	     
                <br />      
                <h4 style="color:white">Contos da língua portuguesa (Brasil e Portugal) </h4>     
                <br />              
                <div>
           ...
           <br />
            ...
            <br />
             <div class="container-fluid" style="background-color:black">	     
                <br />      
                <h4 style="color:white">Machado de Assis - O Alienista (Áudio Livro) </h4>     
                <br />              
                <div>
                <div class='col-xs-12 col-sm-4 text-center' style="background-color:black">                 
                   <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/EPIOfcH82Io" frameborder="0" allowfullscreen></iframe>  </div>  <br />   </div>
                <div class='col-xs-12 col-sm-4 text-center' style="background-color:black">                 
                   <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/776UH4WyfRc" frameborder="0" allowfullscreen></iframe>  </div>  <br />   </div>
                <div class='col-xs-12 col-sm-4 text-center' style="background-color:black">                 
                   <div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/xCFUIZQXnAU" frameborder="0" allowfullscreen></iframe>  </div>  <br />   </div>                
               </div> 
             </div> 
