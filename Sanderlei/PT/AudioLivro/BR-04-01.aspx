<%@ Page Title="Lima Barreto - O Triste Fim de Policarpo Quaresma - 01 / 15" Language="C#" MasterPageFile="~/PT/SitePTLivro.master" AutoEventWireup="true"  %>
    ...
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>            
            <h1> Lima Barreto - O Triste Fim de Policarpo Quaresma - 01 / 15	</h1>
            <br />
              <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/5GXtv4KPQxw" frameborder="0" allowfullscreen></iframe>
         ...
         <br /> 
                ...
                <br /> 
              <h3 class='text-center'> I - A Lição de Violão </h3>
               <br /> 
