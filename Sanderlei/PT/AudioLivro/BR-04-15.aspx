<%@ Page Title="Lima Barreto - Triste Fim de Policarpo Quaresma - 15 / 15" Language="C#" MasterPageFile="~/PT/SitePTLivro.master" AutoEventWireup="true" CodeBehind="BR-04-15.aspx.cs" Inherits="Sanderlei.PT.AudioLivro.BR_04_15" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">   
    <meta name="description" content=" Como lhe parecia ilógico com ele mesmo estar ali metido naquele estreito calabouço. Pois ele, o Quaresma plácido, o Quaresma de tão profundos pensamentos patrióticos, merecia aquele triste fim? De que maneira sorrateira o Destino o arrastara até ali, sem que ele pudesse pressentir o seu extravagante propósito, tão aparentemente sem relação com o resto da sua vida? Teria sido ele com os seus atos passados, com as suas ações encadeadas no tempo, que fizera com que aquele velho deus docilmente o trouxesse até à execução de tal desígnio? Ou teriam sido os fatos externos que venceram a ele, Quaresma, e fizeram-no escravo da sentença da onipotente divindade? Ele não sabia, e, quando teimava em pensar, as duas cousas se baralhavam, se emaranhavam e a conclusão certa e exata lhe fugia." /> 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
    <!-- Conteudo  --> 
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>            
            <h1> Lima Barreto - Triste Fim de Policarpo Quaresma - 15 / 15	</h1>
            <br />
              <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7Krr2lRBG9c" frameborder="0" allowfullscreen></iframe>
...
<p>Ricardo expôs o seu pedido e esperou com paciência a resposta, que custou a vir. Por fim, Inocêncio disse, sacudindo a cabeça e olhando o inferior cheio de severidade: </p>
...
<p>-Vais comprometer-se. Sabes que... 
...
<p>- É isto! “Eu”, porque “eu”, porque “eu”, é só “eu”, para aqui, “eu”para ali... Não pensas noutra 
