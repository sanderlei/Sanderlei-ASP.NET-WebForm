<%@ Page Title="Alvarez de Azevedo - Lembrança de Morrer" Language="C#" MasterPageFile="~/PT/SitePTPoesia.master" AutoEventWireup="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
      ...
      <div class='container panel-body'>
        <div class='col-xs-12 col-md-12 text-center'>
            <br>  <h1>Alvarez de Azevedo - Lembrança de Morrer</h1>  <br> <br> 
              <div class="embed-responsive embed-responsive-16by9">
                 <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2fYw7KFMAks" frameborder="0" allowfullscreen></iframe>  </div>  <br> 
            <div class='text-center' style='line-height:1.7'> 
                <Br /> 
                 <p> </p> 
                <br />
             <h3>   Alvarez de Azevedo - Lembrança de Morrer</h3>
                <br />
<p>Quando em meu peito rebentar-se a fibra,</p> 
<p>Que o espírito enlaça à dor vivente,</p> 
<p>Não derramem por mim nenhuma lágrima</p> 
...
<p>Pouco - bem poucos... e que não zombavam</p> 
<p>Quando, em noites de febre endoudecido,</p> 
...
<p>À sombra de uma cruz, e escrevam nela:</p> 
<p>Foi poeta - sonhou - e amou na vida.</p> 
<br />
<p>Sombras do vale, noites da montanha</p> 
<p>Que minha alma cantou e amava tanto,</p> 
...
<p>Deixai a lua pratear-me a lousa!</p> 

                <br />
<h4>Manuel Antônio Álvares de Azevedo (1831—1852) </h4>
<h4>foi um escritor da segunda geração romântica (Ultra-Romântica).</h4>
